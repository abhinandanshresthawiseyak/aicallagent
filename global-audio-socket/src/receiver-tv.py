...
def handle_connection(conn):
    ...
    with wave.open(f"/app/audios/Worldlink/tv_issue/tv_issue1yes.wav", 'r') as wav_file:
    ...
    with open('/app/receivertype_template/receiver_tv.json', 'r') as file:
        data = json.load(file)
    ...
    tts_folder_location='audios/Worldlink/tv_issue'
    ...
    callHandler.nepali=True                                                                                                                                                                     # It's a receiver
    start_thread=False

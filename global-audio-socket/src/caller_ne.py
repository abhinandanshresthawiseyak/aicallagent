...
def handle_connection(conn):
    ...
    url = "http://192.168.79.109:8001/assigned_container_user"
    ...
    while conn.connected:
        ...
        if start_thread!=True:
            requests.post(callHandler.call_logs_url, params={'caller_id': callHandler.caller_id,'event_type': 'Call Started','event_detail': f'{call_type}'}, headers={'accept': 'application/json'})
            time.sleep(1)
